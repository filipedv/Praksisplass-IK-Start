...
function GuardianScreen({ onBack, motherHeight, setMotherHeight, fatherHeight, setFatherHeight }) {
  return (
    <div className="pb-4">
      <TopBar title="Foresatte" onBack={onBack} />
      <div className="px-4 space-y-4">
        <div className="flex flex-col items-center gap-2 py-2">
          ...
          <span className="text-xs text-slate-400 text-center px-6">
            Registrer høyden til foresatte på spillerens profil.
          </span>
        </div>

        <Card className="p-4 space-y-4">
          <label className="block">
            <span className="text-xs text-slate-500 mb-1 block">Mor — høyde (cm)</span>
            <input
              value={motherHeight}
          ...
          <label className="block">
            <span className="text-xs text-slate-500 mb-1 block">Far — høyde (cm)</span>
            <input
              value={fatherHeight}
...
// ---------------------------------------------------------------------------
// Profil — same access as the player has, plus the Foresatte height card
// ---------------------------------------------------------------------------
    ...
    <div className="px-4 pb-4">
      ...
      <Card className="p-0 mb-4 overflow-hidden">
        ...
        >
          ...
          <div className="text-left">
            <p className="text-sm font-medium text-slate-800">Foresatte</p>
            <p className="text-xs text-slate-400">Mor og Far</p>
          </div>
